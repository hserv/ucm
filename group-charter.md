# **Unified Care Model (UCM) Community Group Charter – Draft**

## Purpose
Organizations involved in healthcare, behavioral health, social care, housing, justice, education, public
health, and other human-service domains increasingly need to exchange, integrate, analyze, and reason
over information that spans these multiple domains of care. Existing standards, information models,
...
The UCM establishes a stable set of reusable semantic concepts, relationship patterns, and architectural
principles that support consistent semantic alignment across diverse domains. These semantic assets
...
providing a durable foundation for future innovation.
...
• Semantic alignment guidance and governance principles.

## Operating Principle: Use-Case-Driven Development
The UCM shall evolve through community-contributed use cases. Each proposed enhancement should be
supported by one or more use cases documenting the purpose and business problem, expected business
...
The Community Group will build upon W3C Semantic Web standards, including RDF, RDFS, OWL, and
...
## Long-Term Vision
By providing a stable semantic bridge among existing standards and ontologies, the UCM will support
coordinated whole-person care, interoperable applications, cross-domain reasoning, integrated analytics,
and trustworthy AI. The goal of the group is to produce a W3C standard.
